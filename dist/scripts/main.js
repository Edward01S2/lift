...
/******/ 	__webpack_require__.p = "/wp-content/themes/lift/dist/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lity__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lity___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lity__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fortawesome_fontawesome_svg_core__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fortawesome_free_brands_svg_icons__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__routes_postTypeArchiveEvent__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__routes_singleStory__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__routes_blog__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__routes_stories__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__routes_liftInAction__ = __webpack_require__(21);
...
__WEBPACK_IMPORTED_MODULE_2__fortawesome_fontawesome_svg_core__["b" /* library */].add(__WEBPACK_IMPORTED_MODULE_3__fortawesome_free_brands_svg_icons__["a" /* faFacebookF */], __WEBPACK_IMPORTED_MODULE_3__fortawesome_free_brands_svg_icons__["c" /* faTwitter */], __WEBPACK_IMPORTED_MODULE_3__fortawesome_free_brands_svg_icons__["b" /* faLinkedinIn */], __WEBPACK_IMPORTED_MODULE_3__fortawesome_free_brands_svg_icons__["d" /* faYoutube */]);
__WEBPACK_IMPORTED_MODULE_2__fortawesome_fontawesome_svg_core__["a" /* dom */].watch();
...
var routes = new __WEBPACK_IMPORTED_MODULE_4__util_Router__["a" /* default */]({
  ...
  postTypeArchiveEvent: __WEBPACK_IMPORTED_MODULE_8__routes_postTypeArchiveEvent__["a" /* default */],
  stories: __WEBPACK_IMPORTED_MODULE_11__routes_stories__["a" /* default */],
  singleStory: __WEBPACK_IMPORTED_MODULE_9__routes_singleStory__["a" /* default */],
  blog: __WEBPACK_IMPORTED_MODULE_10__routes_blog__["a" /* default */],
  liftInAction: __WEBPACK_IMPORTED_MODULE_12__routes_liftInAction__["a" /* default */],
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return faLinkedinIn; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return faTwitter; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return faYoutube; });
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__map_js__ = __webpack_require__(14);
...
/* WEBPACK VAR INJECTION */(function(jQuery, Raphael) {(function($, document, window, Raphael, undefined) {
  ...
  var methods = {
    ...
    _initCreateStates: function() {
      ...
      for(state in paths) {
        stateAttr = {};
        if(this$1.options.stateSpecificStyles[state]) {
          $.extend(stateAttr, attr, this$1.options.stateSpecificStyles[state]);
        } else {
          stateAttr = attr;
        }
        this$1.stateShapes[state] = R.path(paths[state]).attr(stateAttr);
        this$1.topShape = this$1.stateShapes[state];
        
        this$1.stateHitAreas[state] = R.path(paths[state]).attr({fill: "#000",
      "stroke-width": 0, "opacity" : 0.0, 'cursor': 'pointer'});
        this$1.stateHitAreas[state].node.dataState = state;
        this$1.stateShapes[state].node.setAttribute("id", state);
      }
      ...
      for(state in this$1.stateHitAreas) {
        this$1.stateHitAreas[state].toFront();
        $(this$1.stateHitAreas[state].node).bind('mouseout', this$1._onMouseOutProxy);
        $(this$1.stateHitAreas[state].node).bind('click touchend', this$1._onClickProxy);
        $(this$1.stateHitAreas[state].node).bind('mouseover', this$1._onMouseOverProxy);
        
      }
      
      
      // Create the bounding boxes for the shapes
      for(state in this$1.stateShapes) {
        var bbox = this$1.stateShapes[state].getBBox();
        for(var v in bbox) {
          if( $.isNumeric(bbox[v]) ) {
            bbox[v] = bbox[v] * this$1.scale;
          }
        }
        this$1.bboxesForStateShapes[state] = bbox;
      }
    },
    ...
    _initCreateLabels: function() {
      ...
      for(i=0; i<neStates.length; ++i) {
        ...
        this$1._initCreateStateLabel( state, x, y );
      }
      ...
      for(i=0; i<num_terrs; ++i) {
        terr = this$1.options.includeTerritories[i];
        
        // position - only one row of territories
        x = terrBoxX;
        y = (i*2)*downBy + terrBoxY;

        this$1._initCreateStateLabel( terr, x, y );
      }

      // Bind events
      for(state in this$1.labelHitAreas) {
        this$1.labelHitAreas[state].toFront();
        $(this$1.labelHitAreas[state].node).bind('mouseout', this$1._onMouseOutProxy);
        $(this$1.labelHitAreas[state].node).bind('click touchend', this$1._onClickProxy);
        $(this$1.labelHitAreas[state].node).bind('mouseover', this$1._onMouseOverProxy);
      }
	},
    ...
    getStateShapes: function() {
      ...
      for(var stateName in this$1.stateShapes) {
        this$1._getStateShapes[stateName] = {
          shape: this$1.stateShapes[stateName],
          hitArea: this$1.stateHitAreas[stateName],
          labelBacking: stateName in this$1.labelShapes ? this$1.labelShapes[stateName] : null,
          labelText: stateName in this$1.labelTexts ? this$1.labelTexts[stateName] : null,
          labelHitArea: stateName in this$1.labelHitAreas ? this$1.labelHitAreas[stateName] : null,
          name: stateName, 
        };
      }
