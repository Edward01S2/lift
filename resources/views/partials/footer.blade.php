    ...
    <div class="flex flex-col items-center">
      ...
      <div class="social-links flex mb-4 md:mb-2">
        @foreach($options_page->options['networks'] as $social)
          <a href="{!! $social['link'] !!}" target="_blank" class="group relative text-white fill-current flex items-center justify-center px-1 cursor-pointer hover:text-white md:px-2">
