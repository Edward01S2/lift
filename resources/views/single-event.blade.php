...
@while(have_posts()) @php the_post() @endphp
      ...
      <div class="relative container mx-auto z-20">
        <div class="p-4 md:flex md:items-center md:py-8 lg:justify-center">
          ...
          <div class="text-center mt-8 md:mt-0">
            <a class="block uppercase bg-l-orange text-white px-4 py-2 shadow shadow-md font-semibold tracking-wide hover:bg-l-blue hover:text-white" href="{!! $register_link !!}">Register</a>
          </div>
        </div>
        <div class="p-4 pt-4">
          <div class="event-content text-l-blue lg:flex">
            <div class="event-about bg-white text-lg p-8 lg:w-1/2">
              ...
              <div class="text-center mt-12 mb-8 md:mb-4">
                <a class="uppercase bg-l-orange text-white px-8 py-4 font-semibold tracking-wide shadow shadow-md hover:bg-l-blue hover:text-white" href="{!! $register_link !!}">Register</a>
              </div>
            </div>
            <div class="mt-8 bg-white p-8 text-lg lg:mt-0 lg:w-1/2 lg:border-l-2 lg:border-l-teal lg:border-dashed lg:flex lg:flex-col lg:justify-center xl:items-center">
              <div>
                @if($event_logo)
  ...
  <section class="agenda-bg bg-l-blue-100">
    <div class="p-4 container mx-auto lg:flex lg:pb-12">
      ...
      @else
      <div class="bg-white p-8 text-l-blue text-lg mb-8 lg:text-center lg:w-full">
      @endif
    ...
    <div class="event-map">
      <div class="container mx-auto">
        <div class="p-4 text-center text-white md:pt-12 lg:pt-0">
        ...
        <div>
          <div class="map-container lg:py-8 lg:px-0 lg:flex xl:p-0 xl:pt-8">
            @if($map_image)
